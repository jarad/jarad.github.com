...
require(xtable)
d = data.frame("Statistic"=c("# of games", "Win %", "Points/game", "Rushing yards/game"),
               "With Peterson"=c(NA, 49.5, 23.1, 142.1), 
               "Without Peterson"=c(9, 44.4, 25.9, 141.0),
               check.names=FALSE)
print(xtable(d, digits=1), type="html", include.rownames=FALSE)
```
