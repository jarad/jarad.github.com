...
\pause
We had a sample size of 110 with $\overline{x}=202.2$ bushels per acre and 
...
\[ 
202 \pm 1.984\frac{31.6}{\sqrt{110}} = 
...
The mean composite score on the ACT among the students at a large Midwestern 
University is 24. 
