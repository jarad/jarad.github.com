...
\[
\overline{y} = \frac{0+1+2+0+4+0+1+2+3+2}{10} = 1.5.
\]
\end{example}
\end{frame}
...
The sample mean of these observations is 
\[
\overline{y} = \frac{0+1+2+0+4+0+1+2+3+60}{10} = 7.3.
\]
\end{example}
...
The \alert{ordered} observations are 0,0,0,1,1,2,2,2,3,4.
\pause 
The second quartile (median) is 1.5, 
the first quartile is 0, and the third quartile is 2.
\end{example}
...
The \alert{ordered} observations are 0,0,0,1,1,2,2,2,3,4.
\pause 
The 5-number summary is 0,0,1.5,2,4.
\end{example}
\end{frame}
...
business is 0,1,2,0,4,0,1,2,3,2. 
\pause
The minimum is 0, the maximum is 4, and the range is 4-0=4.
\end{example}
\end{frame}
...
business is 0,1,2,0,4,0,1,2,3,2. 
\pause
The Q1 is 0, Q3 is 2, and the interquartile range is 2-0=2.
\end{example}
\end{frame}
...
\[ 
s^2 = \frac{(0-1.5)^2 + (1-1.5)^2 + \cdots (2-1.5)^2}{10-1} = 1.8\overline{3}.
\]
\end{example}
\end{frame}
...
\[ 
s = \sqrt{1.8\overline{3}} \approx 1.354.
\]
\end{example}
...
\item Whiskers that extend out to 
  ...
  \end{itemize} Q3+1.5IQR on the high side.
  \end{itemize}
