...
It is okay if it isn't perfect. \pause 
...
\begin{itemize}
\item in 2 physically different locations \pause and, separately,
...
\begin{itemize}
\item cleaned/munged/wrangled \pause
...
The scripts should use the tidy data to create
\begin{itemize}
\item figures,
\item tables,
\item reports, and/or
