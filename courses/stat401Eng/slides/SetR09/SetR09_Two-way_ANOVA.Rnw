...
\frame{\frametitle{Summary}
	\begin{itemize}[<+->]
	\item Use {\tt lsmeans} to answer questions of scientific interest.
...
The analysis can be completed just like the balanced design using {\tt lsmeans} to answer scientific questions of interest. 
