...
\frametitle{Data}
<<echo=FALSE>>=
ggplot(d, aes(trt, inf)) + 
  geom_boxplot(color="gray") + 
  geom_jitter(height=0) +
  title(xlab = "Sulfur", ylab = "Scab percent") + 
  theme_bw()
@
\end{frame}
...
\begin{itemize}[<+->]
\item The group sulfur levels ($X_i$) are 12, 6, 3, 0, 3, 6, and 12 (100lbs/acre). \pause 
...
% \pause \\ \\
% \gamma &= \frac{1}{6}\left(\mu_{F12}+ 0 \mu_{F6} -3 \mu_{F3}-6 \mu_O -3\mu_{S3} + 0\mu_{S6} + 6\mu_{S12})
\end{array} \]
