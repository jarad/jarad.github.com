...
\item Review symbols $\in, \notin, \subset, \subseteq, \supset, \supseteq$.
  ...
  \item if every member of set A is also a member of set B, 
  then A is said to be a subset of B, 
  written $A \subseteq B$ (A is said to be contained in B).
  \end{itemize}
...
\item $P(S\cap D) = 20/1000 = 0.02$.
\item $P(D|S) = P(S\cap D)/P(S) = 0.02/0.5 = 0.04$. 
\end{itemize}
}
\end{frame}
...
\[ 
P(A \cap B) = P(A)\times P(B) = 0.6 \times 0.9 = 0.54. 
\]
