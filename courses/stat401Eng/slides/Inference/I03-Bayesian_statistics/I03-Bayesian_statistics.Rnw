...
# Special cases
qbeta(.95, a+y, b+n-y)          # if y=0, use a lower one-sided credible interval (0 up to here)
qbeta(.05, a+y, b+n-y)          # if y=n, use a upper one-sided credible interval (here up to 1)
@
