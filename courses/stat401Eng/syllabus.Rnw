...
STAT 401C, Statistical Methods for Research Workers \\
Spring 2017 \\
\end{tabular}
} % End \LARGE
...
Course hours: & MWF 1:10-2:00 in Town 0270 & Office hours: & R 9:30-11:30  \\
& T 10-11:50 @ Snedecor 1105 && @ Snedecor 2208\\
TA: & Yan Wang & Office hours: & MW 10-11 \\
& \href{mailto:wangyan@iastate.edu}{\texttt{wangyan@iastate.edu}} &&@ Snedecor 2404 \\
\\
\multicolumn{4}{@{}l}{Course webpage: on Canvas and \url{http://jarad.me/courses/stat401Eng}} \\
...
% \hline
% && {\bf FINAL EXAM} (May 4, 9:45-11:45) \\
% \hline
% \end{tabular}
% \end{center}
