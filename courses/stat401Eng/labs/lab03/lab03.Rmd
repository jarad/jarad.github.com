...
[Change your working directory](../lab02/lab02.html#working_directory). 
...
If X is a random variable and it is uniformly distributed between a and b, 
then we write $X\sim Unif(a,b)$ and this means that X can take on any value 
...
#### Quantiles of a normal distribution activity
...
## Binomial questions of interest activity
...
## Beta distribution activity

Use the web and R help to plot the pdf/pmf, cdf, and quantile function for a 
[beta distribution](https://en.wikipedia.org/wiki/Beta_distribution). 
Sample 999 random values from a beta distribution and plot a histogram of the 
results together with the pdf. 

This activity wants you to do more on your own, 
i.e. determine the support for a beta distribution, 
determine the values of the parameters, 
determine how the code works in R, 
and then use that information to draw the appropriate figures.

<div id="beta_activity_solution" style="display:none"> 
```{r, purl=FALSE}
a <- 2
b <- 3

opar = par(mfrow=c(2,2))
curve(dbeta(x, shape1 = a, shape2 = b), main = "PDF for a beta distribution")
curve(pbeta(x, shape1 = a, shape2 = b), main = "CDF for a beta distribution")
curve(qbeta(x, shape1 = a, shape2 = b), main = "Quantile function for a beta distribution")

draws <- rbeta(999, shape1 = a, shape2 = b)
hist(draws, probability = TRUE)
curve(dbeta(x, shape1 = a, shape2 = b), col = "red", add = TRUE)
par(opar)
```
</div> 
<button title="Show a solution" type="button" onclick="if(document.getElementById('beta_activity_solution') .style.display=='none') {document.getElementById('beta_activity_solution') .style.display=''}else{document.getElementById('beta_activity_solution') .style.display='none'}">Show/Hide Solution</button>
