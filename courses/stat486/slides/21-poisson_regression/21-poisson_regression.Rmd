...
confint(m)
```
The fact that the interval for the coefficient for Year provides evidence that
(if the remaining assumptions in the model are true) that the coefficient
for Year is unlikely to be zero. 
