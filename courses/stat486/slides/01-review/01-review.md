...
The expectation is $E[Y] = m$ and the variance is $Var[Y] = C$. While
...
When the censoring is large or occurs for a large number of the
...
The most useful aspect of SLR models is the simplicity of
interpretation:
