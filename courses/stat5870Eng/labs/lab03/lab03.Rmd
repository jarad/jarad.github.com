...
1 - pnorm(2, mean = mn, sd = sqrt(vr)) # Approximate probability of 3 or more sensor failures
```
</details>
\
\
...
1 - pnorm(2 + 1/2, mean = mn, sd = sqrt(vr)) # Approximate probability of 3 or more sensor failures
```
</details>
\
\
How good is this normal approximate (based on CLT) to the true probabilities
