...
\frame{\frametitle{Simple hypothesis}	
	...
	\begin{itemize}
	\item Mean lifetime for N/R40 and N/R50 diet is different. \pause
	\item Mean lifetime for N/R40 is different than for N/R50 and R/R50 combined. \pause
	\item Mean lifetime for NP and N/N85 combined is different than for low calorie diets combined.
	\end{itemize}
