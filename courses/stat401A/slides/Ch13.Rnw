...
When dealing with an incomplete design, it is often easier to treat the analysis as a one-way ANOVA and use contrasts to answer appropriate questions of interest.
