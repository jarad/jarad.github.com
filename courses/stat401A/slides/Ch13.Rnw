...
Suppose for some reason that one of the variety B, density 30 samples was contaminated. \pause Although you started with a balanced design, the data is now unbalanced. \pause Fortunately, we can still use the tools we have used previously. 
...
{\tiny
\[ \begin{array}{lllllll}
\mu_i &= \beta_0 &+ \beta_1\I(V_i=A,D_i=10) &+ \beta_1\I(V_i=A,D_i=20)&+ \beta_1\I(V_i=A,D_i=30)&+ \beta_1\I(V_i=A,D_i=40) \\
&&+ \beta_1\I(V_i=B,D_i=10)&+ \beta_1\I(V_i=B,D_i=20)&&+ \beta_1\I(V_i=B,D_i=40) \\
&&+ \beta_1\I(V_i=C,D_i=10)&+ \beta_1\I(V_i=C,D_i=20)&+ \beta_1\I(V_i=C,D_i=30)&+ \beta_1\I(V_i=C,D_i=40)
\end{array} \]
}
\end{frame}
