...
\frame{\frametitle{Two-way ANOVA}
	\begin{itemize}[<+->]
	\item Setup: Two categorical explanatory variables with $\mathrm{I}$ and $\mathrm{J}$ levels
	\item Model:
	\[ Y_{ijk} \stackrel{ind}{\sim} N(\mu_{ij},\sigma^2) \]
	where $Y_{ijk}$ is the 
	\begin{itemize}
	\item $k$th observation at the 
	\item $i$th level of variable 1 (variety) with $i=1,\ldots,\mathrm{I}$ and the 
	\item $j$th level of variable 2 (density) with $j=1,\ldots,\mathrm{J}$.
	\end{itemize}
...
\frame{\frametitle{As a regression model}
	...
	\item Build indicator variables, e.g. $\mathrm{I}(V_i=A)$ and $\mathrm{I}(D_i=10)$. 
	\item The additive model: {\scriptsize
	\[ \begin{array}{rl} \mu_{ij} =& \beta_0 + \beta_1\mathrm{I}(V_i=A) + \beta_2\mathrm{I}(V_i=B) \\
	&+ \beta_3\mathrm{I}(D_i=10)+\beta_4\mathrm{I}(D_i=20)+\beta_5\mathrm{I}(D_i=30).
	\end{array} \]
	...
	\[ \begin{array}{rl} \mu_{ij} =& \beta_0 + \beta_1\mathrm{I}(V_i=A) + \beta_2\mathrm{I}(V_i=B) \\
	&+ \beta_3\mathrm{I}(D_i=10)+\beta_4\mathrm{I}(D_i=20)+\beta_5\mathrm{I}(D_i=30) \\ \\
	&+\beta_6\mathrm{I}(V_i=A)\mathrm{I}(D_i=10)+\beta_7\mathrm{I}(V_i=A)\mathrm{I}(D_i=20)+\beta_8\mathrm{I}(V_i=A)\mathrm{I}(D_i=30) \\
	&+\beta_9\mathrm{I}(V_i=B)\mathrm{I}(D_i=10)+\beta_{10}\mathrm{I}(V_i=B)\mathrm{I}(D_i=20)+\beta_{11}\mathrm{I}(V_i=B)\mathrm{I}(D_i=30) \\
	\end{array} \]
...
<<>>=
interaction.plot(tomato$Density, tomato$Variety, tomato$Yield, fun=mean, lwd=2)
@
...
\frame{\frametitle{Summary}
	\begin{itemize}[<+->]
	\item The analysis follows the design.
