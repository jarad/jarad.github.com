...
<<"robustness data2", echo=FALSE>>=
options(width=170)
d = 
data.frame(n1=c(10,10,10,100,100,100), n2=c(10,20,40,100,200,400), 
           "r0.25x"= c(95.2,83,71,94.8,86.5,71.6),
           "r0.5x" = c(94.2,89.3,82.6,96.2,88.3,81.5),
           "r1x"   = c(94.7,94.4,95.2,95.4,94.8,95.0),
           "r2x"   = c(95.2,98.7,99.5,95.3,98.8,99.5),
           "r4x"   = c(94.5,99.1,99.9,95.1,99.4,99.9))
d
@
