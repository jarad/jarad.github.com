...
\begin{itemize}[<+->]
\item $\exp(\beta_0)$ is the median of $Y$ when $X$ is zero and 
\item $\exp(\beta_1)$ is the multiplicative effect on the median of $Y$ for a one unit increase in the explanatory variable.
\end{itemize}
...
\begin{itemize}[<+->]
\item $\exp(\beta_0)$ is the median corn yield per acre when fertilizer level is zero and 
\item $\exp(\beta_1)$ is the multiplicative effect in median corn yield per acre when fertilizer is increase by 1 lbs/acre. 
\end{itemize}
...
\begin{itemize}[<+->]
\item $\exp(\beta_0)$ is the median of $Y$ when $X$ is 1 and 
...
\begin{itemize}[<+->]
\item $\exp(\beta_0)$ is the median corn yield per acre when fertilizer level is 1 lb/acre and 
