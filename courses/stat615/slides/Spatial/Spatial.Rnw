...
\begin{frame}[fragile]
<<CARBayes3, dependson='CARBayes', echo=TRUE>>=
model_iar    <- S.CARiar(formula=Y ~ x1 + x2, family='gaussian', W=W, burnin=5000, n.sample=10000, verbose=FALSE)
model_iar
@
\end{frame}
