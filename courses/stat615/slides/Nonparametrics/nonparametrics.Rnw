...
Commonly, we have $m_h=m$, $v_h=v$, $c_h=c$, and $d_h=d$. \pause If the data have been standardized (scaled and centered), a reasonable default is $m=0$, $v=1$, $c=2$, and $d=4$ (BDA3 pg 535). \pause A reasonable default for $a$ is $1/H$ (BDA3 pg 536). 
...
The steps of a Gibbs sampler with target distribution 
\[ 
