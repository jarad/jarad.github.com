...
\item indicator of being male as the independent variable ($X$).
\end{itemize}
In this model, $100(e^{\beta_1}-1)$ will be the percent difference in median
...
\item Interpretation:
  \begin{itemize}
  \item When independent variable is logged, $100(e^\beta-1)$ is the percent change in median response.
  \item When dependent variable is logged, ...
