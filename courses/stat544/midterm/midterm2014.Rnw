...
2 & \shortcorrect{16} & \shortcorrect{6} & \shortcorrect{0} & \shortcorrect{1} & \shortcorrect{25}  & \shortcorrect{96} \\
...
\longcorrect[\vspace{1in}]{Divide all cells in Table \ref{tab:cookies}}
...
\shortcorrect{The answers given here are based on the attached output and differ from the actual exam given.}
  ...
  \item $\rho_1$, the rate of failures for O-rings for company 1 \longcorrect[\vspace{0.3in}]{(0.46,1.76)}
  \item the {\bf mean failure time} for O-rings from company 1 \longcorrect[\vspace{0.3in}]{(0.57,2.17)}
  \end{enumerate}
