...
See if you can google to find out how to swap the axes, 
...
<div id="boxplot_scatterplot_activity_solution" style="display:none"> 
```{r, purl=FALSE}
ggplot(airquality,     
       aes(x=Month, y=Wind, group=Month)) + 
  geom_boxplot(outlier.shape = NA, color='grey') +         
...
<button title="Show a solution" type="button" onclick="if(document.getElementById('boxplot_scatterplot_activity_solution') .style.display=='none') {document.getElementById('boxplot_scatterplot_activity_solution') .style.display=''}else{document.getElementById('boxplot_scatterplot_activity_solution') .style.display='none'}">Show/Hide Solution</button>
