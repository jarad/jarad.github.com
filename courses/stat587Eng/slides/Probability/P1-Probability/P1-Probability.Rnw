...
Assume the probability the WiFi network is up is 0.6 and the ISP network is up is 0.9. \pause
...
\[ 
P(A \intersection B) = P(A)\times P(B) = 0.6 \times 0.9 = 0.54. \hspace{2in}
\]
...
$P(F\union H)=1-(1-0.8424)(1-0.9141)\approx 0.99$.
\end{enumerate}
\end{frame}
