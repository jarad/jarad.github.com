...
\bc
\includegraphics[width=\textwidth]{include/NCSAT2}
\nc\ec
...
\begin{frame}[t]
\frametitle{Toughness}

{\tiny \url{https://www.researchgate.net/figure/Histograms-representing-the-distributions-of-the-statistically-generated-estimates-of_fig7_261106716}}

\bc
\includegraphics[width=0.9\textwidth]{include/toughness}
\nc\ec
...
\bc
\includegraphics[width=0.9\textwidth]{include/yield}
\nc\ec
\end{frame}
...
An astronomer wants to measure the distance, $d$, from Earth to a star. \pause
Suppose the procedure has a known standard deviation of 2 parsecs. \pause
The astronomer takes 30 iid measurements and finds the average of these 
measurements to be 29.4 parsecs. \pause
...
\bc
\includegraphics[width=0.95\textwidth]{include/parallax}
\nc\ec
...
$E[X_i]=d$ and $Var[X_i]=\sigma^2=4$. 
\pause
The estimate of $d$ is
\[ \overline{X}_n=\frac{(X_1+X_2+\dots+X_n)}{n} = 29.4. \]
\bc
and, by the Central Limit Theorem, 
we believe $\overline{X}_n \stackrel{\cdot}{\sim} N(d, \sigma^2/n)$ where $n=30$. \pause
We want to find
{\footnotesize
\[ \begin{array}{rl}
...
\frametitle{Summary}
\begin{itemize}
\item Central Limit Theorem \pause
  \begin{itemize}
  \item Sums
  \item Averages
  \end{itemize}
