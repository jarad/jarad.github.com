...
This design allowed us to examine the importance of ... caregiving stress (...number of years since a child's diagnosis [of a chronic disease]).
...
ggplot(d, aes(x=x, y=y, group = mean)) + 
