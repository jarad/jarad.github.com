...
\title{R04 - Categorical explanatory variables}
...
Reconsider the mice lifetime data set but only consider the diets R/R50 and 
$N/R50$:
\pause
...
Considering only the R/R50 and N/R50 diets. 
\pause
Let 
